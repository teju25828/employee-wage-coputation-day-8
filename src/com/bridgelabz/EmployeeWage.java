...
public class EmployeeWage {
        String companyName;
        int fullDayHours = 8, partTimeHours = 4, wagePerDay = 0,presentDayCount=0,absentDayCount=0,partTimeDayCount=0;
        int numberOfWorkingDays,workingHours,wagePerHours=1,totalWage,totalHours,wagePerHour;
            void getadata()
            {
